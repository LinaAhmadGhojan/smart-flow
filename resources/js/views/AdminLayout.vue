...
const navEntries: NavEntry[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { to: '/admin/groups', label: 'المجموعات' },
  ...
  },
  {
    ...
    children: [
      { to: '/admin/projects', label: 'مشاريع التنفيذ' },
      { to: '/admin/project-masters', label: 'مشاريع الموقع' },
    ],
  },
  {
    type: 'group',
    ...
    children: [
      { to: '/admin/quotations', label: 'عروض الأسعار' },
      { to: '/admin/invoices', label: 'الفواتير' },
      { to: '/admin/delivery-notes', label: 'أذونات التسليم' },
      { to: '/admin/payments', label: 'الدفعات' },
    ],
  },
  {
    type: 'group',
    ...
    children: [
      ...
      { to: '/admin/suppliers', label: 'الموردون' },
      { to: '/admin/engineers', label: 'المهندسون' },
      { to: '/admin/reviews', label: 'التقييمات' },
      { to: '/admin/appointments', label: 'المواعيد' },
      { to: '/admin/study-requests', label: 'طلبات الدراسة', badge: 'study-requests' },
    ],
  },
  {
    type: 'link',
