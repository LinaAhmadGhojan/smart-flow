      ...
      <div class="flex items-center justify-between gap-4">
        ...
        <nav class="hidden lg:flex items-center gap-1">
          ...
          <button
            ...
            @click="toggleLocale"
          >
            <svg class="lang-toggle__globe" viewBox="0 0 24 24" fill="none" stroke="currentColor" aria-hidden="true">
              <circle cx="12" cy="12" r="9" stroke-width="1.8" />
              <path stroke-width="1.8" d="M3 12h18M12 3c2.5 2.8 3.8 5.8 3.8 9s-1.3 6.2-3.8 9c-2.5-2.8-3.8-5.8-3.8-9S9.5 5.8 12 3z" />
            </svg>
            <span class="lang-toggle__code">{{ locale === 'ar' ? 'EN' : 'AR' }}</span>
          </button>
        ...
        <div class="flex items-center gap-2 lg:hidden">
          ...
          <button type="button" class="p-2 text-white" @click="isMenuOpen = !isMenuOpen" :aria-label="t('menu')">
