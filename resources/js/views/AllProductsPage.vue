      ...
      <div class="container mx-auto px-4">
        <div class="mb-12">
          ...
          <div class="text-center">
            <h1 class="text-4xl md:text-5xl font-bold text-blue-900 mb-1">منتجاتنا الكاملة</h1>
            <p class="text-xl text-gray-600">تصفح جميع الحلول الذكية المتوفرة لديك</p>
          </div>
        </div>
...
const displayName = (product: Product) => product.name_ar || product.name
...
const getWhatsAppLink = (product: Product) => {
  const message =
    ...
    `مرحباً، أرغب في الاستفسار عن المنتج: ${displayName(product)} - السعر: ${formatPrice(product.price)} AED`
