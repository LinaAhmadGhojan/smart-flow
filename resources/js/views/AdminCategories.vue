<template>
  <div>
    <h1 class="text-2xl font-bold text-gray-900 mb-6">إدارة الفئات</h1>
    <div>
        ...
        <table class="sf-table divide-y divide-gray-200">
          <thead class="bg-gray-50">
            <tr>
              ...
              <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">المنتجات</th>
    ...
    <ConfirmDeleteModal
      :open="!!deleteTarget"
      title="حذف الفئة؟"
      :message="deleteTarget ? (deleteTarget.name_ar || deleteTarget.name) : ''"
